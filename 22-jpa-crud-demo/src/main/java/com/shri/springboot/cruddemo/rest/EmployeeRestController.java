package com.shri.springboot.cruddemo.rest;
...
import com.shri.springboot.cruddemo.service.EmployeeService;
...
public class EmployeeRestController {
	...
	public Employee addEmployee(@RequestBody Employee theEmployee) {
		...
		// just in case the rest client sends the id we will set it to 0
		theEmployee.setId(0);
