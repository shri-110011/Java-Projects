...
public class PostfixToPrefixConvertor {
	
public String convertPostfixToPrefix(String postfixExp) {
		...
		for(int i=0; i<postFixExp_elements.length; i++) {
			 ...
			 */
				...
				stack.push(element+" "+operand1+" "+operand2);
			}
	...
	public static void main(String[] args) {
		...
		PostfixToPrefixConvertor ptp = new PostfixToPrefixConvertor();
		String postFixExp = "K L + M N * - O P ^ W * U / V / T * + Q +";
		
		System.out.println(ptp.convertPostfixToPrefix(postFixExp));
